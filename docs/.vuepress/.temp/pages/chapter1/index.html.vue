<template><div><h1 id="初识-typescript" tabindex="-1"><a class="header-anchor" href="#初识-typescript"><span>初识 TypeScript</span></a></h1>
<p>TypeScript 作为 JavaScript 语言的超集，它为 JavaScript 添加了可选择的类型标注，大大增强了代码的可读性和可维护性。同时，它提供最新和不断发展的 JavaScript 特性，能让我们建立更健壮的组件。</p>
<h2 id="typescript-的特点" tabindex="-1"><a class="header-anchor" href="#typescript-的特点"><span>TypeScript 的特点</span></a></h2>
