<template><div><h1 id="课程回顾与总结" tabindex="-1"><a class="header-anchor" href="#课程回顾与总结"><span>课程回顾与总结</span></a></h1>
<p>这节课我们主要是对课程做回顾与总结，总共分为以下几个方面。</p>
<ul>
...
<p>另外如果对 Vue.js 开发感兴趣的同学，也可以关注我的 Vue 三部曲：<a href="https://coding.imooc.com/class/74.html" target="_blank" rel="noopener noreferrer">Vue.js2.5+cube-ui重构饿了么App（中级）</a>   -&gt; <a href="https://coding.imooc.com/class/107.html" target="_blank" rel="noopener noreferrer">Vue2.0开发企业级移动端音乐Web App（高级）</a> -&gt; <a href="https://coding.imooc.com/class/228.html" target="_blank" rel="noopener noreferrer">Vue.js源码全方位深入解析（高级）</a>。未来随着 Vue.js 升级到 3.0，这些课程也会做同步更新（音乐课程和源码课程会重新录制），所以完全不用担心版本升级问题，也希望大家都能够支持我的正版课程。</p>
